	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Чекбокс', 'sampletheme' ); ?></th>
					<td>
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Немного о себе 1', 'sampletheme' ); ?></th>
					<td>
						<textarea id="sample_theme_options[nemnogo_o_sebe_1]" class="large-text" cols="50" rows="10" name="sample_theme_options[nemnogo_o_sebe_1]"><?php echo esc_textarea( $options['nemnogo_o_sebe_1'] ); ?></textarea>
						<label class="description" for="sample_theme_options[nemnogo_o_sebe_1]"><?php _e( 'Sample text box', 'nemnogo_o_sebe_1' ); ?></label>
					</td>
				</tr>
                <tr valign="top"><th scope="row"><?php _e( 'Немного о себе 2', 'sampletheme' ); ?></th>
                    <td>
                        <textarea id="sample_theme_options[nemnogo_o_sebe_2]" class="large-text" cols="50" rows="10" name="sample_theme_options[nemnogo_o_sebe_2]"><?php echo esc_textarea( $options['nemnogo_o_sebe_2'] ); ?></textarea>
                        <label class="description" for="sample_theme_options[nemnogo_o_sebe_2]"><?php _e( 'Sample text box', 'nemnogo_o_sebe_2' ); ?></label>
                    </td>
                </tr>
			</table>
